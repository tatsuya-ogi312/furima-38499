  ...
  describe '購入情報の保存' do
    ...
    context '内容に問題がある場合' do
      ...
      it 'phone_numberが10桁未満では保存できないこと' do
        ...
        @order_address.valid?
        expect(@order_address.errors.full_messages).to include("Phone number don't be used")
      end
      ...
      it 'phone_numberが"-"入りでは保存できないこと' do
        @order_address.phone_number = '111-1111-11111'
        @order_address.valid?
        expect(@order_address.errors.full_messages).to include("Phone number don't be used")
      end
